...
import { a as ITEMS, c as Select, d as SelectTrigger, f as SelectValue, g as shareToWhatsApp, h as shareApp, i as GENERIC_SHARE_TEXT, l as SelectContent, m as cn, r as FEEDBACK_MAILTO, s as SIZES_BY_ITEM, t as Button, u as SelectItem } from "./share-aQZZ6x_u.mjs";
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-8 pt-6 border-t flex items-center justify-center gap-5 text-xs text-muted-foreground",
